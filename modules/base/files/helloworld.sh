...
cd /var/lib//tomcat6/webapps wget "http://localhost:8081/nexus/service/local/repositories/${FIND_REPOSITORYID}/content/${FIND_GROUPID_PATH}/${FIND_ARTIFACTID}/${FIND_VERSION}/${FIND_ARTIFACTID}-${FIND_VERSION}.jar" 2>/dev/null
